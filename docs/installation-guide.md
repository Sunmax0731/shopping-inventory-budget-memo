...
2. `dist/shopping-inventory-budget-memo-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/shopping-inventory-budget-memo.git
cd shopping-inventory-budget-memo
